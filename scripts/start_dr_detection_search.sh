...
python src/search/train_search.py --unrolled --train_portion 1.0 --cutout --report_freq_hessian 2 --space s1 --dataset dr-detection --drop_path_prob 0.2 --weight_decay 0.0121 --batch_size 4
