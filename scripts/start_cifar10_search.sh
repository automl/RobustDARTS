...
python src/search/train_search.py --unrolled --train_portion 0.1 --cutout --report_freq_hessian 2 --space s1 --dataset cifar10 --drop_path_prob 0.2 --weight_decay 0.0121
